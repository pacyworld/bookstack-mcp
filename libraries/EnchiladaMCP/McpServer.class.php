...
class McpServer
{
	 ...
	 *               version when we support it. Revisions newer than ours are
	 *               capability-gated and additive, so a client asking for one
	 *               gets our latest and decides whether to continue.
	 */
	private array $supportedProtocolVersions = [self::DEFAULT_PROTOCOL_VERSION, '2025-06-18', '2025-03-26'];
